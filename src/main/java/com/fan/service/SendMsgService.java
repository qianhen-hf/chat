...
public class SendMsgService {
    ...
    public Boolean aliSend() {
        ...
        try {
            ...
            sendSmsRequest.setPhoneNumbers("18523091556");
            //必填:短信签名-可在短信控制台中找到
            sendSmsRequest.setSignName(smsConfig.getSignature());
            //必填:短信模板-可在短信控制台中找到
            sendSmsRequest.setTemplateCode("SMS_137790152");
            //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
            //友情提示:如果JSON中需要带换行符,请参照标准的JSON协议对换行符的要求,比如短信内容中包含\r\n的情况在JSON中需要表示成\\r\\n,否则会导致JSON在服务端解析失败
            sendSmsRequest.setTemplateParam("{\"name\":\"wy\", \"code\":\"321545\"}");
